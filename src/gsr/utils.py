...
def visualize_mv_registration(gaussian_list, pred_rel_tsfms, gt_rel_tsfms, device:int=0):
    vis_pred_list, vis_gt_list = [], []
    pred_abs_tsfm = torch.eye(4, device=device)
    gt_abs_tsfm = torch.eye(4, device=device)
