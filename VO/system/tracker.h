...
public:
  TrackerSettings(const std::string &settingsFile) {
    I3D_LOG(i3d::debug) << "TrackerSettings reading setting file: "
                        << settingsFile;
    ...
    I3D_LOG(i3d::debug) << "CHECK_INIT_VALUES = " << CHECK_INIT_VALUES;
    I3D_LOG(i3d::debug) << "nFramesHistogramVoting = "
                        << nFramesHistogramVoting;
    I3D_LOG(i3d::debug) << "CHECK_TRACKING_RESULTS = "
                        << CHECK_TRACKING_RESULTS;
    I3D_LOG(i3d::debug) << "USE_EDGE_FILTER = "
                        << optimizerSettings.USE_EDGE_FILTER;
    I3D_LOG(i3d::debug) << "N_FRAMES_HIST_VOTING = " << nFramesHistogramVoting;
  }
