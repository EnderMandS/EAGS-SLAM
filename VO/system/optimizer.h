...
private:
  double calcErrorAndBuffers(const std::shared_ptr<ImgPyramidRGBD> &refFrame,
...
public:
  ...
  getInterpolatedElement43(std::shared_ptr<Eigen::Vector4f> mat, const float x,
    ...
    const Eigen::Vector4f *bp = mat.get() + ix + iy * width;
